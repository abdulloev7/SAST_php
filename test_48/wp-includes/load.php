...
function wp_start_scraping_edited_file_errors() {
	...
	if ( get_transient( 'scrape_key_' . $key ) !== $nonce ) {
		echo "###### wp_scraping_result_start:$key ######";  // SecurityCheck-XSS Ложное срабатывание, в sanitize_key происходит нормальная санация, тут будет безопасная строка
		echo wp_json_encode(
			array(
		...
		echo "###### wp_scraping_result_end:$key ######"; // SecurityCheck-XSS Ложное срабатывание, в sanitize_key происходит нормальная санация, тут будет безопасная строка
		die();
	}
